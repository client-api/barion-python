...
**funding_sources** | [**List[FundingSources]**](FundingSources.md) | An array of strings containing the allowed funding sources that can be used to complete the payment. | 
...
**recurrence_type** | [**RecurrenceType**](RecurrenceType.md) | Required for &#x60;3DS&#x60;, when executing token payments. Describes the nature of the token payment. | [optional] 
